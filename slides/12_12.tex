...
\hypersetup{
  pdftitle={A \textbackslash rightarrow \textbackslash Box \textbackslash Diamond A (in KTB)},
...
\title{\(A \rightarrow \Box \Diamond A\) (in KTB)}
...
In B, false \(\Diamond\) sentences have to be false one step backwards
as well as one step forwards.
