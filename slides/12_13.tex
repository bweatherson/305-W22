...
\hypersetup{
  pdftitle={\textbackslash Box A \textbackslash rightarrow \textbackslash Box \textbackslash Box A (in KTB)},
...
\title{\(\Box A \rightarrow \Box \Box A\) (in KTB)}
...
\begin{frame}{\(\Box A \rightarrow \Box \Box A\)}
\protect\hypertarget{box-a-rightarrow-box-box-a-6}{}
...
And that's it. We've applied all the rules. The extra rules for T and B
don't change much here from the basic tableau in K.
...
\item
  ...
  \(w_1Rw_{1.1}, w_{1.1}Rw_{1.1.1}, w_1Rw_1, w_{1.1}Rw_{1.1}, w_{1.1.1}Rw_{1.1.1}, w_{1.1}Rw_1\)
  and \(w_{1.1.1}Rw_{1.1}\)
\item
  The first two are from the tree, the next three from T and the last
  two from B.
\item
