...
\hypersetup{
  pdftitle={305 Lecture 4.4 - Introducing Natural Deduction},
...
\title{305 Lecture 4.4 - Introducing Natural Deduction}
...
\begin{frame}{What is Natural Deduction}
\protect\hypertarget{what-is-natural-deduction}{}
\begin{itemize}[<+->]
\tightlist
\item
  A proof system that looks like reasoning in natural language
\item
  Every step is an inference that conforms to one of a small number of
  good rules.
\end{itemize}
\end{frame}
...
\item
  The length of proofs grows more or less linearly with the complexity
  of the argument, not exponentially.
\item
  The method can be generalised well beyond basic propositional logic.
\end{itemize}
\end{frame}

\begin{frame}{Tables, Trees and Proofs}
\protect\hypertarget{tables-trees-and-proofs}{}
\begin{itemize}
\tightlist
\item
  The last two advantages are really advantages of natural deduction
  over tables.
\item
