...
\hypersetup{
  pdftitle={305 Lecture 3.1 - Propositional Logic},
...
\title{305 Lecture 3.1 - Propositional Logic}
...
This doesn't correspond to any particular part of the book, but I think
it's helpful before going onto chapter 12.
\end{frame}
...
\item
  I'm using these funny shaped letters because they get used in
  \emph{Boxes and Diamonds}, and because they make our lives easier when
  we start using trees.
\end{itemize}
\end{frame}
...
(And note that here we'll simplify further, by not covering iff.)
\end{frame}
...
\tightlist
\item
  We will see how to use truth tables to tell which sentences are
  logical truths in propositional logic.
\end{itemize}
\end{frame}
