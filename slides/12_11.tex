...
\hypersetup{
  pdftitle={A \textbackslash rightarrow \textbackslash Box \textbackslash Diamond A (in S4)},
...
\title{\(A \rightarrow \Box \Diamond A\) (in S4)}
...
\begin{frame}{\(A \rightarrow \Box \Diamond A\)}
\protect\hypertarget{a-rightarrow-box-diamond-a}{}
...
\begin{frame}{\(A \rightarrow \Box \Diamond A\)}
\protect\hypertarget{a-rightarrow-box-diamond-a-1}{}
...
\begin{frame}{\(A \rightarrow \Box \Diamond A\)}
\protect\hypertarget{a-rightarrow-box-diamond-a-2}{}
...
\begin{frame}{\(A \rightarrow \Box \Diamond A\)}
\protect\hypertarget{a-rightarrow-box-diamond-a-3}{}
...
\begin{frame}{\(A \rightarrow \Box \Diamond A\)}
\protect\hypertarget{a-rightarrow-box-diamond-a-4}{}
...
\item
  The accessibility relations are \(w_1Rw_{1.1}, w_1Rw_1\) and
  \(w_{1.1}Rw_{1.1}\).
\item
  The first is from the tree, the next two from reflexivity.
\item
  In this case, transitivity doesn't require anything more. (Though
  double check this!)
\item
...
\item
  So \(\Box \Diamond A\) will be false at \(w_1\), while \(A\) is true,
  as required.
\end{itemize}
